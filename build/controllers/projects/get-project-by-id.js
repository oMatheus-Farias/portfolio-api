...
exports.GetProjectByIdController = void 0;
...
class GetProjectByIdController {
    ...
    execute(projectId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const isIdValid = (0, validation_id_1.checkIfIdIsValid)(projectId);
                if (!isIdValid) {
                    return (0, errors_1.badRequest)("The provided id is not valid. Please provide a valid id.");
                }
                yield projects_1.getByIdSchema.parseAsync({ id: projectId });
                const project = yield this.getProjectByIdUseCase.execute(projectId);
                return {
                    statusCode: 200,
                    body: project,
                };
