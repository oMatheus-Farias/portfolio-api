...
(0, vitest_1.describe)("Postgres Create Project Repository", () => {
    ...
    const makeSut = () => {
        const sut = new create_project_1.PostgresCreateProjectRepository();
        return {
            sut,
        };
    };
    (0, vitest_1.it)("should create project on database", () => __awaiter(void 0, void 0, void 0, function* () {
        const { sut } = makeSut();
        yield app_1.prisma.user.create({
            data: createUserParams,
        });
        const result = yield sut.execute({ params: createProjectParams });
