...
(0, vitest_1.describe)("Postgres Get Project By Id Repository", () => {
    ...
    const makeSut = () => {
        const sut = new get_project_by_id_1.PostgresGetProjectByIdRepository();
        return {
            sut,
        };
    };
    (0, vitest_1.it)("should get project by id on database", () => __awaiter(void 0, void 0, void 0, function* () {
        const { sut } = makeSut();
        ...
        const result = yield sut.execute(createProjectParams.id);
