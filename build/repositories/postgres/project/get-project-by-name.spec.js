...
(0, vitest_1.describe)("Postgres Get Project By Id Repository", () => {
    ...
    const makeSut = () => {
        const sut = new get_project_by_name_1.PostgresGetProjectByNameRepository();
        return {
            sut,
        };
    };
    (0, vitest_1.it)("should get project by name on database", () => __awaiter(void 0, void 0, void 0, function* () {
        const { sut } = makeSut();
        ...
        const result = yield sut.execute(createProjectParams.name);
